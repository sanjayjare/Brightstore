...
function deduceTrackingCode($tracking_code)
    {
	...
	//echo deduceTrackingCode('047277978947144');
?>
<!DOCTYPE HTML>
<html>
<head>
...
//$res = mysql_query("select row_id,userName, password, statusUrl, companyID, companyName, statusVersion, shippingUrl, shippingVersion from Companies where userName != '' and  password != '' and statusUrl != '' and statusVersion != '' order by companyName");
...
$(document).ready(function() {
	...
	function callapi(selSupplier, qval, dtype, referencenumber, statusTimeStamp){
		...
		var newurl="shippingstatusdetail_aj.php";
		var data={};
